package me.zeeplockd.sigmoid.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(Sigmoid.HUD_GROUP, "example", "HUD element example.", HudExample::new);
